...
namespace RPGGame.Items.ShieldsMain
{
    public class Shields : BaseItem
    {
        ...
        public Shields(string shieldName, string shieldType, int price, float weight, int defenseValue, int defenseModifier, params Type[] allowableClasses)
